...
#
# Script generated by Vivado on Fri Oct 20 18:25:22 -0500 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Zack/labone/mainproject/VivadoProjects/MainProjectTestbench/MainProjectTestbench.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
