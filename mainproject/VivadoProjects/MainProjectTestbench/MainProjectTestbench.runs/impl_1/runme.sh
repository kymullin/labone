...
HD_PWD='C:/Users/Zack/labone/mainproject/VivadoProjects/MainProjectTestbench/MainProjectTestbench.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WasherTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WasherTop.tcl -notrace
