...
# Switches
set_property PACKAGE_PIN V17 [get_ports {PWM_OUT}]					
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {SnsA}]					
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {Forward}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Forward}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {Backward}]					
